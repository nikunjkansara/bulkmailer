            ...
            <div class="sub-section">
				...
				<p>
                    {!! trans('messages.purchasing_intro_' . $payment_method->type, [
                        ...
                        'price' => horsefly\Library\Tool::format_price($subscription->price, $subscription->currency_format)
                    ]) !!}
                </p>
				...
				<div class="panelz">
					<div class="panel-bodyz">
						<form id="checkout-form" action="{{ action('PaymentController@braintree_credit_card', $subscription->uid) }}" method="post">
						  ...
						  <input type="submit" value="Pay {{ horsefly\Library\Tool::format_price($subscription->price, $subscription->currency_format) }}" class="btn btn-primary bg-teal-800" />
						</form>
					</div>
				</div>
			</div>
