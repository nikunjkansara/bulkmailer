...
@section('content')
    ...
    <h2>
        <span class="text-semibold"><i class="icon-list2 mr-10"></i> {{ trans('messages.domains') }}</span>
    </h2>
    ...
    <form class="listing-form"
        ...
        per-page="{{ horsefly\Model\SendingDomain::$itemsPerPage }}"
    >
        <div class="row top-list-controls">
                    ...
                    <div class="filter-box">
                        <div class="btn-group list_actions hide">
                            ...
                            <ul class="dropdown-menu">
                                <li><a delete-confirm="{{ trans('messages.delete_sending_domains_confirm') }}" href="{{ action('SendingDomainController@delete') }}"><i class="icon-trash"></i> {{ trans('messages.delete') }}</a></li>
                            </ul>
                        </div>
            ...
            @if (Auth::user()->customer->can('create', new horsefly\Model\SendingDomain()))
                <div class="col-md-3 text-right">
                    <a href="{{ action('SendingDomainController@create') }}" type="button" class="btn bg-info-800">
