...
@section('content')
    ...
    <form class="listing-form"
        ...
        per-page="{{ horsefly\Model\Blacklist::$itemsPerPage }}"
    >
        ...
        <div class="row top-list-controls">
                    ...
                    <div class="filter-box">
                        ...
                        <div class="btn-group list_actions hide">
                            ...
                            <ul class="dropdown-menu">
                                <li><a delete-confirm="{{ trans('messages.remove_blacklist_confirm') }}" href="{{ action('BlacklistController@delete') }}"><i class="icon-trash"></i> {{ trans('messages.delete') }}</a></li>
                            </ul>
                        </div>
            ...
            <div class="col-md-3">
                @if (Auth::user()->customer->can('import', new horsefly\Model\Blacklist()))
                    <div class="text-right">
                        <a href="{{ action('BlacklistController@import') }}" type="button" class="btn bg-info-800">
