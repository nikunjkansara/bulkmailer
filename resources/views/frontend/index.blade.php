...
<section id="hero">
	<div class="hero-container" data-aos="fade-up">
		<h1>
			Horsefly Mailer Provides Better <br />eMailing Marketing solutions <br />for
			every Business
		</h1>
		<h2>We provide a platform that help the Business to connect to their
			Clients and Support their Business</h2>
		<a href="#about" class="btn-get-started scrollto"><i
	...
	<section id="counts" class="counts  section-bg">
		<div class="container">
			...
			<div class="row no-gutters">
				...
				<div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
					<div class="count-box">
						<i class="bi bi-emoji-smile"></i> <span data-purecounter-start="0"
							data-purecounter-end="232" data-purecounter-duration="1"
				...
				<div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
					<div class="count-box">
						<i class="bi bi-people"></i> <span data-purecounter-start="0"
			...
			<ul class="faq-list" data-aos="fade-up" data-aos-delay="100">
				...
				<li>
					<div data-bs-toggle="collapse" href="#faq2"
						...
						pellentesque? <i class="bi bi-chevron-down icon-show"></i><i
							class="bi bi-chevron-up icon-close"></i>
					</div>
				...
				<li>
					<div data-bs-toggle="collapse" href="#faq3"
						class="collapsed question">
						Dolor sit amet consectetur adipiscing elit pellentesque habitant
						morbi? <i class="bi bi-chevron-down icon-show"></i><i
							class="bi bi-chevron-up icon-close"></i>
					</div>
				...
				<li>
					<div data-bs-toggle="collapse" href="#faq4"
						class="collapsed question">
						Ac odio tempor orci dapibus. Aliquam eleifend mi in nulla? <i
							class="bi bi-chevron-down icon-show"></i><i
							class="bi bi-chevron-up icon-close"></i>
					</div>
				...
				<li>
					<div data-bs-toggle="collapse" href="#faq5"
						class="collapsed question">
				...
				<li>
					<div data-bs-toggle="collapse" href="#faq6"
						...
						nunc eget lorem dolor? <i class="bi bi-chevron-down icon-show"></i><i
							class="bi bi-chevron-up icon-close"></i>
					</div>
