	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			...
			<div class="automation-top-menu">
				<span class="mr-3"><i>{{ trans('messages.automation.designer.last_saved', [ 'minute' => rand(1,3) ]) }}</i></span>
	...
	<main role="main">
		<div class="automation2">
			<div class="diagram text-center scrollbar-inner">				
				<svg id="svg" style="overflow: auto" width="2800" height="1800" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
