                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="sub_section">
                                ...
                                @include('helpers.form_control', ['type' => 'select', 'name' => 'language_id', 'label' => trans('messages.language'), 'value' => $customer->language_id, 'options' => horsefly\Model\Language::getSelectOptions(), 'include_blank' => trans('messages.choose'), 'rules' => $customer->rules()])
                                ...
                                <div class="row">
                                    <div class="col-md-6 color-box">
                                        @include('helpers.form_control', [
                                            ...
                                            'help_class' => 'customer',
                                            'options' => horsefly\Model\Customer::colors("color_scheme"),
                                            'rules' => '',
                                        ])
                                    </div>
                                </div>
