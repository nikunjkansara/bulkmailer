@php
	...
	$transactions[] = [
		...
		'amount' => horsefly\Library\Tool::format_price($customer->calcChangePlan($newPlan)['amount'], $newPlan->currency->format),
	];
...
<p>
	{!! trans('messages.subscription.change_plan.checkout.coinpayments', [
		...
		'end_on' => horsefly\Library\Tool::formatDate($subscription->ends_at),
		'amount' => horsefly\Library\Tool::format_price($customer->calcChangePlan($newPlan)['amount'], $newPlan->currency->format)
	]) !!}
</p>
