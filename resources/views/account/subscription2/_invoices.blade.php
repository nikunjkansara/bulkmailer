                        ...
                        <tr>
                            <td>
                                <span class="no-margin kq_search">
                                    {{ horsefly\Library\Tool::formatDate(Carbon\Carbon::createFromTimestamp($invoice->createdAt)) }}
                                </span>
                            </td>
                            <td>
                                <span class="no-margin kq_search">
                            ...
                            <td>
                                <span class="no-margin kq_search">
                                    {{ horsefly\Library\Tool::formatDate(Carbon\Carbon::createFromTimestamp($invoice->periodEndsAt)) }}
                                </span>
                            </td>                        
                            <td>
                                <span class="no-margin kq_search">
