@if (\horsefly\Model\Setting::get('site_favicon'))
    <link rel="shortcut icon" type="image/png" href="{{ action('SettingController@file', \horsefly\Model\Setting::get('site_favicon')) }}"/>
@else
...
<meta name="msapplication-TileImage" content="{{ URL::asset('favicon/favicon.png') }}">
