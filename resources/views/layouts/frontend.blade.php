	...
	<div class="navbar navbar-{{ Auth::user()->customer->getColorScheme() == "white" ? "default" : "inverse" }} navbar-fixed-top">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				...
				@if (
					Auth::user()->customer->can("read", new horsefly\Model\SendingServer()) ||					
                    Auth::user()->customer->can("read", new horsefly\Model\EmailVerificationServer()) ||
					Auth::user()->customer->can("read", new horsefly\Model\Blacklist()) ||
					true
				)
					...
					>
						...
						<ul class="dropdown-menu">
							...
							@if (Auth::user()->customer->can("read", new horsefly\Model\SendingServer()))
                            ...
                            @if (Auth::user()->customer->can("read", new horsefly\Model\EmailVerificationServer()))
							...
							@endif
							@if (Auth::user()->customer->can("read", new horsefly\Model\Blacklist()))
			...
			<ul class="nav navbar-nav navbar-right">
				<!--<li class="dropdown language-switch">
					<a class="dropdown-toggle" data-toggle="dropdown">
						{{ horsefly\Model\Language::getByCode(Config::get('app.locale'))->name }}
						<span class="caret"></span>
					</a>

					<ul class="dropdown-menu">
						@foreach(horsefly\Model\Language::getAll() as $language)
							<li class="{{ horsefly\Model\Language::getByCode(Config::get('app.locale'))->code == $language->code ? "active" : "" }}">
								<a>{{ $language->name }}</a>
							</li>
						@endforeach
					</ul>
