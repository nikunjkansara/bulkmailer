    ...
    @if (isset($subscription))
        <ul class="dotted-list topborder section">
            ...
            <li>
                ...
                <div class="lastUnit size1of2">
                    <mc:flag>{{ trans('messages.payment.' . horsefly\Model\Setting::get('system.payment_gateway')) }}</mc:flag>
                </div>
            </li>
            <li>
                <div class="unit size1of2">
            ...
            <li>
                ...
                <div class="lastUnit size1of2">
                    <mc:flag>{{ horsefly\Library\Tool::formatDate($next_billing_date) }}</mc:flag>
                </div>
            </li>
        </ul>
    @else
