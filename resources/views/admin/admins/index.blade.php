...
@section('content')
				...
				<form class="listing-form"
					...
					per-page="{{ horsefly\Model\Admin::$itemsPerPage }}"
				>
					<div class="row top-list-controls">
								...
								<div class="filter-box">
									...
									<span class="filter-group">
										...
										<select class="select" name="admin_group_id">
											...
											@foreach (horsefly\Model\AdminGroup::getSelectOptions(Auth::user()->admin) as $option)
						...
						@can('create', new horsefly\Model\Admin())
