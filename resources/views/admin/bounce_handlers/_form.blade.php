					<div class="row">
						<div class="col-sm-6 col-md-4">
							@include('helpers.form_control', [
								...
								'rules' => horsefly\Model\BounceHandler::rules()
							])
						</div>
						<div class="col-sm-6 col-md-4">
							@include('helpers.form_control', [
					...
					<div class="row">
						<div class="col-sm-6 col-md-4">
							@include('helpers.form_control', [
								...
								'options' => horsefly\Model\BounceHandler::protocolSelectOptions(),
								'help_class' => 'bounce_handler',
								'rules' => horsefly\Model\BounceHandler::rules()
							])
						</div>
						<div class="col-sm-6 col-md-4">
							@include('helpers.form_control', [
								...
								'options' => horsefly\Model\BounceHandler::encryptionSelectOptions(),
								'help_class' => 'bounce_handler',
								'rules' => horsefly\Model\BounceHandler::rules()
							])
						</div>
