<div class="row">
    <div class="col-sm-6 col-md-4">
        @include('helpers.form_control', [
            ...
            'rules' => horsefly\Model\FeedbackLoopHandler::rules()
        ])
    </div>
    <div class="col-sm-6 col-md-4">
        @include('helpers.form_control', [
...
<div class="row">
    ...
    <div class="col-sm-6 col-md-4">
        @include('helpers.form_control', [
            ...
            'options' => horsefly\Model\FeedbackLoopHandler::protocolSelectOptions(),
            'help_class' => 'feedback_loop_handler',
            'rules' => horsefly\Model\FeedbackLoopHandler::rules()
        ])
    </div>
...
<div class="row">
    ...
    <div class="col-sm-6 col-md-4">
        @include('helpers.form_control', [
            ...
            'options' => horsefly\Model\FeedbackLoopHandler::encryptionSelectOptions(),
            'help_class' => 'feedback_loop_handler',
            'rules' => horsefly\Model\FeedbackLoopHandler::rules()
        ])
    </div>
