...
@section('page_header')
			...
			<div class="page-title">
				...
				<h1>
					<span class="text-semibold"><i class="icon-list2"></i> {{ trans('messages.feedback_loop_handlers') }}</span>
				</h1>
			</div>
...
@section('content')
				...
				<form class="listing-form"
					...
					per-page="{{ horsefly\Model\FeedbackLoopHandler::$itemsPerPage }}"
				>
					<div class="row top-list-controls">
								...
								<div class="filter-box">
									<div class="btn-group list_actions hide">
										...
										<ul class="dropdown-menu">
											<li><a delete-confirm="{{ trans('messages.delete_feedback_loop_handlers_confirm') }}" href="{{ action('Admin\FeedbackLoopHandlerController@delete') }}"><i class="icon-trash"></i> {{ trans('messages.delete') }}</a></li>
										</ul>
									</div>
						...
						@can('create', new horsefly\Model\FeedbackLoopHandler())
							<div class="col-md-3 text-right">
								<a href="{{ action('Admin\FeedbackLoopHandlerController@create') }}" type="button" class="btn bg-info-800">
