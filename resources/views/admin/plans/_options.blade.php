...
<div class="tabbable">
    <ul class="nav nav-tabs nav-tabs-top">
        ...
        <li class="text-semibold"><a href="#top-tab7" data-toggle="tab">
            <i class="icon-gear"></i> {{ trans('messages.plan.setting') }}</a>
        </li>
    </ul>
    <div class="tab-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    @include('admin.plans._form_sending_server', [
                        ...
                        'update_link' => action('Admin\PlanController@sendingServers', $plan->uid),
                    ])
                </div>
            </div>
        </div>
        ...
        <div class="tab-pane" id="top-tab6">
            ...
            <div class="email-verification-servers-no">
                ...
                @if(!horsefly\Model\EmailVerificationServer::getAllAdminActive()->count())
                ...
                <div class="row email-verification-servers">
                    @foreach (horsefly\Model\EmailVerificationServer::getAllAdminActive()->orderBy("name")->get() as $server)
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
        ...
        <div class="tab-pane" id="top-tab7">
            @include('admin.plans._form_setting', [
                'help_class' => 'plan',
                'rules' => $plan->rules()
            ])
        </div>
