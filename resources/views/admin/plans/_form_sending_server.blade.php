    ...
    <div class="form-group control-radio">
        <div class="radio_box" data-popup='tooltip' title="">
            <label class="main-control">
                <input {{ ($options['sending_server_option'] == \horsefly\Model\Plan::SENDING_SERVER_OPTION_SYSTEM ? 'checked' : '') }} type="radio"
            ...
            <div class="radio_more_box">
                <input type="hidden" name="options[all_sending_servers]" value="no" />
                 @if ($plan->id && $options['sending_server_option'] == \horsefly\Model\Plan::SENDING_SERVER_OPTION_SYSTEM)
        ...
        <div class="radio_box" data-popup='tooltip' title="">
            <label class="main-control">
                <input {{ ($options['sending_server_option'] == \horsefly\Model\Plan::SENDING_SERVER_OPTION_OWN ? 'checked' : '') }} type="radio"
                    name="options[sending_server_option]"
                    value="{{ \horsefly\Model\Plan::SENDING_SERVER_OPTION_OWN }}" class="styled" /><rtitle>{{ trans('messages.plan_option.own_sending_server') }}</rtitle>
                <div class="desc text-normal mb-10">
        ...
        <div class="radio_box" data-popup='tooltip' title="">
            <label class="main-control">
                <input {{ ($options['sending_server_option'] == \horsefly\Model\Plan::SENDING_SERVER_OPTION_SUBACCOUNT ? 'checked' : '') }} type="radio"
                    name="options[sending_server_option]"
