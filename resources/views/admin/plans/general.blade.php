                    ...
                    <div class="stats-boxes">
                        ...
                        <div class="width1of4 stats-box">
                            <h3>
                                ...
                                @if (horsefly\Model\Setting::get('system.payment_gateway'))
                                    <a href="{{ action('Admin\PaymentController@index') }}">{{ trans('messages.payment.' . horsefly\Model\Setting::get('system.payment_gateway')) }}</a>
                                @else
