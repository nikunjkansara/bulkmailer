        ...
        <div class="col-md-12">
            <div class="mc-list-setting mt-20">
                @foreach ($gateways as $name => $gateway)
                    <div class="list-setting bg-{{ $gateway['name'] }} {{ \horsefly\Model\Setting::get('system.payment_gateway') == $name ? 'current' : '' }}">
                        <div class="list-setting-main">
                            <div class="title">
                                <label>{{ trans('messages.payments.' . $name) }}</label>
                                @if (\horsefly\Model\Setting::get('system.payment_gateway') == $name)
