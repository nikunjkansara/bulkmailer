@if ($payment_method->type == \horsefly\Model\PaymentMethod::TYPE_PAYPAL)
    <div class="row">
        <div class="col-md-4">
...
@if ($payment_method->type == \horsefly\Model\PaymentMethod::TYPE_BRAINTREE_PAYPAL ||
    $payment_method->type == \horsefly\Model\PaymentMethod::TYPE_BRAINTREE_CREDIT_CARD
)
    <div class="row">
        <div class="col-md-4">
            @include('helpers.form_control', [
...
@if ($payment_method->type == \horsefly\Model\PaymentMethod::TYPE_STRIPE_CREDIT_CARD)
    <div class="row">
        <div class="col-md-4">
            @include('helpers.form_control', [
                'type' => 'text',
...
@if ($payment_method->type == \horsefly\Model\PaymentMethod::TYPE_PADDLE_CARD)
    <div class="row">
        <div class="col-md-6">
            @include('helpers.form_control', [
                'type' => 'text',
    ...
    <div class="row">
        <div class="col-md-6">
            @include('helpers.form_control', [
                ...
                'label' => trans('messages.paddle.public_key'),
                'value' => $payment_method->getOption('public_key'),
                'help_class' => 'payment_method',
                'rules' => $payment_method->rules()
            ])
        </div>
...
@if ($payment_method->type == \horsefly\Model\PaymentMethod::TYPE_PAYU_MONEY)
    <div class="row">
        <div class="col-md-6">
            @include('helpers.form_control', [
                'type' => 'text',
                'name' => 'options[merchant_key]',
                'label' => trans('messages.payu.merchant_key'),
                'value' => $payment_method->getOption('merchant_key'),
                'help_class' => 'payment_method',
                'rules' => $payment_method->rules()
            ])
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            @include('helpers.form_control', [
                'type' => 'text',
                'name' => 'options[salt]',
                'label' => trans('messages.payu.salt'),
                'value' => $payment_method->getOption('salt'),
                'help_class' => 'payment_method',
                'rules' => $payment_method->rules()
            ])
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            @include('helpers.form_control', [
                'type' => 'select',
                'name' => 'options[payu_base_url]',
                'label' => trans('messages.payu.payu_base_url'),
                'value' => $payment_method->getOption('payu_base_url'),
                'options' => [
                    ['value' => 'https://test.payu.in', 'text' => trans('messages.payu.testing')],
                    ['value' => 'https://secure.payu.in', 'text' => trans('messages.payu.production')],
                ],
                'help_class' => 'payment_method',
                'rules' => $payment_method->rules()
            ])
