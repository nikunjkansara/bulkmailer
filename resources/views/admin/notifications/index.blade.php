				...
				<div class="filter-box">
					...
					<span class="filter-group ml-10">
						...
						<select class="select" name="level">
							...
							<option value="{{ \horsefly\Model\Notification::LEVEL_INFO }}">{{ trans('messages.notification.level.' . \horsefly\Model\Notification::LEVEL_INFO) }}</option>
							<option value="{{ \horsefly\Model\Notification::LEVEL_WARNING }}">{{ trans('messages.notification.level.' . \horsefly\Model\Notification::LEVEL_WARNING) }}</option>
							<option value="{{ \horsefly\Model\Notification::LEVEL_ERROR }}">{{ trans('messages.notification.level.' . \horsefly\Model\Notification::LEVEL_ERROR) }}</option>
						</select>										
					</span>
