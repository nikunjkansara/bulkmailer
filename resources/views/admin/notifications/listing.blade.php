                            ...
                            >
								@foreach ($notifications as $key => $notification)									
									<tr>
                                        ...
                                        <td width="1%">
											@if ($notification->level == \horsefly\Model\Notification::LEVEL_WARNING)
												<i class="lnr lnr-warning bg-warning admin-notification-media"></i>
											@elseif ( false &&$notification->level == \horsefly\Model\Notification::LEVEL_ERROR)
										...
										<td>
											<div class="pull-right">
												...
												<span class="text-muted2">{{ horsefly\Library\Tool::formatDateTime($notification->created_at) }}</span>
											</div>
										</td>
									</tr>
								@endforeach
