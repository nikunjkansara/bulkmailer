...
@section('content')
    ...
    <form id="classic-builder-form" style="margin-top: 56px;" action="{{ action('Admin\TemplateController@update', $template->uid) }}" method="POST" class="ajax_upload_form form-validate-jqueryz builder-classic-form">
        {{ csrf_field() }}
        ...
        <div class="row mr-0 ml-0">
            ...
            <div class="col-md-3 pr-0 pb-0 sidebar pr-4 pt-4 pl-4" style="overflow:auto;background:#f5f5f5">
                ...
                <hr>
                @include('elements._tags', ['tags' => horsefly\Model\Template::tags()])
            </div>            
        </div>   
    </form> 
            ...
            editor = tinymce.init({
                ...
                setup: function (editor) {
                    ...
                    editor.ui.registry.addMenuButton('acelletags', {
                        ...
                        @foreach(horsefly\Model\Template::tags() as $tag)
                            items.push({
                                type: 'menuitem',
                                text: '{{ $tag["name"] }}',
                                onAction: function (_) {
