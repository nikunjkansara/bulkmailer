                    ...
                    @if (is_object($item->subscription))
                        <div class="single-stat-box pull-left ml-20">
                            ...
                            <span class="text-muted">
                                <strong>{{ \horsefly\Library\Tool::format_number($item->getSendingQuotaUsage()) }}/{{ ($item->getSendingQuota() == -1) ? '∞' : \horsefly\Library\Tool::format_number($item->getSendingQuota()) }}</strong>
