		...
		<div class="col-md-12">
			<form
				...
				<div class="upload_file before">
					{!! trans('messages.max_file_upload', ['size' => \horsefly\Library\Tool::maxFileUploadInBytes()]) !!}

					@include('helpers.form_control', ['required' => true, 'type' => 'file', 'label' => trans('messages.upload_file'), 'name' => 'file', 'value' => $list->name])

					@if (\horsefly\Model\Setting::get('import_subscribers_commitment'))
						<div class="mt-40">
							@include('helpers.form_control', [
								...
								'value' => 'no',
								'required' => true,
								'label' => \horsefly\Model\Setting::get('import_subscribers_commitment'),
								'options' => ['no','yes'],
								'rules' => []
							])
						</div>
