...
class Cashier
{
    ...
    public static function getPaymentGateway($name=null, $fields=null)
    {
        ...
        switch ($config['name']) {
            case 'direct':
                return new \horsefly\Cashier\Services\DirectPaymentGateway(
                    $config['fields']['payment_instruction'],
                    $config['fields']['confirmation_message']
                );
            case 'stripe':
                return new \horsefly\Cashier\Services\StripePaymentGateway(
                    $config['fields']['secret_key'],
                    $config['fields']['publishable_key'],
                    $config['fields']['always_ask_for_valid_card']
                );
            case 'braintree':
                return new \horsefly\Cashier\Services\BraintreePaymentGateway(
            ...
            case 'coinpayments':
                return new \horsefly\Cashier\Services\CoinpaymentsPaymentGateway(
                    $config['fields']['merchant_id'],
                    $config['fields']['public_key'],
                    $config['fields']['private_key'],
            ...
            case 'paypal':
                return new \horsefly\Cashier\Services\PaypalPaymentGateway(
                    $config['fields']['environment'],
                    $config['fields']['client_id'],
                    $config['fields']['secret']
                );
            case 'paypal_subscription':
                return new \horsefly\Cashier\Services\PaypalSubscriptionPaymentGateway(
                    $config['fields']['environment'],
                    $config['fields']['client_id'],
                    $config['fields']['secret']
                );
