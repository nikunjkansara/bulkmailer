...
class DirectPaymentGateway implements PaymentGatewayInterface {
    ...
    public function getPendingNotice($subscription) {
        ...
        return trans('cashier::messages.direct.has_transaction_pending', [
            ...
            'url' => action('\horsefly\Cashier\Controllers\DirectController@pending', [
    ...
    {
        return action("\horsefly\Cashier\Controllers\\DirectController@pending", [
            'subscription_id' => $subscription->uid,
    ...
    public function getCheckoutUrl($subscription, $returnUrl='/') {
        return action("\horsefly\Cashier\Controllers\DirectController@checkout", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    {
        return action("\horsefly\Cashier\Controllers\\DirectController@changePlan", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
            'plan_id' => $plan_id,
        ]);
    ...
    {
        return action("\horsefly\Cashier\Controllers\\DirectController@renew", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
