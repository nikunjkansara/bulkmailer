...
use horsefly\Library\Contracts\PaymentGatewayInterface;
use Carbon\Carbon;
...
class PaystackPaymentGateway implements PaymentGatewayInterface
{
    ...
    {
        return action("\horsefly\Cashier\Controllers\PaystackController@settings");
    }
    ...
    {
        return \horsefly\Cashier\Cashier::lr_action("\horsefly\Cashier\Controllers\PaystackController@autoBillingDataUpdate", [
    ...
    {
        return \horsefly\Cashier\Cashier::lr_action("\horsefly\Cashier\Controllers\PaystackController@checkout", [
