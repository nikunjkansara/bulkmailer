...
namespace horsefly\Cashier\Services;

use horsefly\Cashier\Cashier;
use horsefly\Cashier\Interfaces\PaymentGatewayInterface;
use horsefly\Cashier\Subscription;
use horsefly\Cashier\SubscriptionParam;
use horsefly\Cashier\InvoiceParam;
use Carbon\Carbon;
use horsefly\Cashier\SubscriptionTransaction;
...
class PaypalSubscriptionPaymentGateway implements PaymentGatewayInterface
{
    ...
    public function initPayPalProduct()
    {
        ...
        $response = $client->request('POST', $uri, [
            ...
            'body' => json_encode([
                ...
                "home_url" => 'https://horseflymailer.com',
            ]),
        ]);
    ...
    public function removePayPalProduct()
    {
        ...
        foreach ($data['plans'] as $key => $connection) {
            ...
            if ($connection['paypal_id']) {
                $plan = \horsefly\Model\Plan::findByUid($connection['uid']);
    ...
    public function suspendPaypalSubscription($subscription)
    {
        ...
        // Get new one if not exist
        $uri = $this->baseUri . '/v1/billing/subscriptions/' . $subscription->getMetadata()['subscriptionID'] . '/suspend';
        $client = new \GuzzleHttp\Client();
        $response = $client->request('POST', $uri, [
            'headers' =>
                [
    ...
    public function activatePaypalSubscription($subscription)
    {
        ...
        // Get new one if not exist
        $uri = $this->baseUri . '/v1/billing/subscriptions/' . $subscription->getMetadata()['subscriptionID'] . '/activate';
        $client = new \GuzzleHttp\Client();
        $response = $client->request('POST', $uri, [
            'headers' =>
                [
    ...
    public function cancelPaypalSubscription($subscription)
    {
        ...
        // Get new one if not exist
        $uri = $this->baseUri . '/v1/billing/subscriptions/' . $subscription->getMetadata()['subscriptionID'] . '/cancel';
        $client = new \GuzzleHttp\Client();
        $response = $client->request('POST', $uri, [
            'headers' =>
                [
    ...
    {        
        // Get new one if not exist
        $uri = $this->baseUri . '/v1/billing/subscriptions/' . $subscriptionID;
        $client = new \GuzzleHttp\Client();
        $response = $client->request('GET', $uri, [
            'headers' =>
            [
    ...
    {
        return action("\horsefly\Cashier\Controllers\\PaypalSubscriptionController@renew", [
    ...
    public function getCheckoutUrl($subscription, $returnUrl='/') {
        return action("\horsefly\Cashier\Controllers\PaypalSubscriptionController@checkout", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    {
        return action("\horsefly\Cashier\Controllers\\PaypalSubscriptionController@changePlan", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
            'plan_id' => $plan_id,
        ]);
    ...
    {
        return action("\horsefly\Cashier\Controllers\\PaypalSubscriptionController@pending", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    {
        return action("\horsefly\Cashier\Controllers\\PaypalSubscriptionController@transactionPending", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    {
        return action("\horsefly\Cashier\Controllers\\PaypalSubscriptionController@ChangePlanpending", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    public function deactivatePayPalPlan($planId)
    {
        try {
            // Deactive remote plan
            $uri = $this->baseUri . '/v1/billing/plans/' . $planId . '/deactivate';
            $client = new \GuzzleHttp\Client();
            $response = $client->request('POST', $uri, [
                'headers' =>
                    [
