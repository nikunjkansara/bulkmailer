...
class PaypalPaymentGateway implements PaymentGatewayInterface
{
    ...
    {
        return action("\horsefly\Cashier\Controllers\\PaypalController@renew", [
    ...
    public function getCheckoutUrl($subscription, $returnUrl='/') {
        return action("\horsefly\Cashier\Controllers\PaypalController@checkout", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    {
        return action("\horsefly\Cashier\Controllers\\PaypalController@changePlan", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
            'plan_id' => $plan_id,
        ]);
    ...
    {
        return action("\horsefly\Cashier\Controllers\\PaypalController@pending", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
