...
use horsefly\Cashier\Library\CoinPayment\CoinpaymentsAPI;
...
class CoinpaymentsPaymentGateway implements PaymentGatewayInterface
{
    ...
    public function getPendingNotice($subscription)
    {
        ...
        return trans('cashier::messages.direct.has_transaction_pending', [
            ...
            'url' => action('\horsefly\Cashier\Controllers\CoinpaymentsController@transactionPending', [
    ...
    {
        return action("\horsefly\Cashier\Controllers\\CoinpaymentsController@renew", [
            'subscription_id' => $subscription->uid,
    ...
    public function getCheckoutUrl($subscription, $returnUrl='/') {
        return action("\horsefly\Cashier\Controllers\CoinpaymentsController@checkout", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    {
        return action("\horsefly\Cashier\Controllers\\CoinpaymentsController@changePlan", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
            'plan_id' => $plan_id,
        ]);
    ...
    {
        return action("\horsefly\Cashier\Controllers\\CoinpaymentsController@pending", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
