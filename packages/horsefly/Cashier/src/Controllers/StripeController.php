...
use horsefly\Cashier\Services\StripePaymentGateway;
...
class StripeController extends Controller
{
    ...
    public function checkout(Request $request, $subscription_id)
    {
        ...
        if (isSiteDemo()) {
            if ($subscription->plan->price == 0) {
                ...
                return redirect()->action('\horsefly\Http\Controllers\AccountSubscriptionController@selectPlan');
            }
            ...
            $session = \Stripe\Checkout\Session::create([
                ...
                'line_items' => [[
                  ...
                  'description' => \horsefly\Model\Setting::get('site_name'),
                ...
                'success_url' => url('/'),
                'cancel_url' => action('\horsefly\Http\Controllers\AccountSubscriptionController@index'),
            ]);
    ...
    public function changePlan(Request $request, $subscription_id)
    {
        ...
        $newPlan = \horsefly\Model\Plan::findByUid($request->plan_id);
