...
class Subscription extends Model
{
    ...
    public function plan()
    {
        ...
        return $this->belongsTo('\horsefly\Model\Plan', 'plan_id', 'uid');
    }
    ...
    {
        // @todo dependency injection
        return $this->belongsTo('\horsefly\Model\Customer', 'user_id', 'uid');
    }
    ...
    {
        // @todo dependency injection
        return $this->hasMany('\horsefly\Cashier\SubscriptionTransaction');
    }
    ...
    {
        // @todo dependency injection
        return $this->hasMany('\horsefly\Cashier\SubscriptionLog');
    }
