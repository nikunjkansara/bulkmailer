    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \horsefly\Cashier\Cashier::public_url('/vendor/acelle-cashier/image/paystack.svg') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">
                <form id="paymentForm">
                ...
                <form id="checkoutForm" method="GET" action="{{ \horsefly\Cashier\Cashier::lr_action('\horsefly\Cashier\Controllers\PaystackController@paymentRedirect') }}">
