        ...
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                @if ($subscription->plan->price == 0)
                    <form method="POST" action="{{ action('\horsefly\Cashier\Controllers\PaypalController@renew', ['subscription_id' => $subscription->uid]) }}">
                        {{ csrf_field() }}
                        ...
                        paypal.Buttons({
                            ...
                            onApprove: function(data, actions) {
                                ...
                                return actions.order.capture().then(function(details) {
                                    ...
                                    form.append(jQuery('<input>', {
                                        'name': 'redirect',
                                        'value': '{{ action('\horsefly\Cashier\Controllers\PaypalController@renew', $subscription->uid) }}',
                                        'type': 'hidden'
                                    }));
                                    form.submit();
                                });
