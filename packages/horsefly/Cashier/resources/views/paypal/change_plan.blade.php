                ...
                @else
                    ...
                    <script>
                        var form = jQuery('<form>', {
                            'action': '{{ action('\horsefly\Cashier\Controllers\PaypalController@paymentRedirect') }}',
                            'target': '_top',
                            'method': 'GET'
                        }).append(jQuery('<input>', {
                            'name': '_token',
                        ...
                        paypal.Buttons({
                            ...
                            onApprove: function(data, actions) {
                                ...
                                return actions.order.capture().then(function(details) {
                                    ...
                                    form.append(jQuery('<input>', {
                                        'name': 'redirect',
                                        'value': '{{ action('\horsefly\Cashier\Controllers\PaypalController@changePlan', $subscription->uid) }}',
                                        'type': 'hidden'
                                    }));
                                    form.submit();
                                });
