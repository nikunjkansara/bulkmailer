        ...
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                {{-- @if (!$transaction) --}}
                    ...
                    <a href="{{ action('\horsefly\Cashier\Controllers\CoinpaymentsController@charge', [
                        'subscription_id' => $subscription->uid,
                    ]) }}" class="btn btn-secondary">{{ trans('cashier::messages.coinpayments.pay_now') }}</a>
                    
                    <form class="mt-5" method="POST" action="{{ action('\horsefly\Cashier\Controllers\CoinpaymentsController@cancelNow', ['subscription_id' => $subscription->uid]) }}">
                        {{ csrf_field() }}
