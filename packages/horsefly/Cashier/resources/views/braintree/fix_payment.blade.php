        ...
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">                
                ...
                <form id="updateCard" style="display: none" action="{{ action('\horsefly\Cashier\Controllers\BraintreeController@updateCard', [
                    ...
                    <input type="hidden" name="redirect" value="{{ action('\horsefly\Cashier\Controllers\BraintreeController@paymentRedirect', [
                        'redirect' => action('\horsefly\Cashier\Controllers\BraintreeController@fixPayment', [
                            'subscription_id' => $subscription->uid,
                        ]),
                    ]) }}" />
                </form>
