    ...
    <body>
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                @if ($newPlan->price == 0)
                    <a href="{{ action('\horsefly\Cashier\Controllers\BraintreeController@changePlanPending', [
                ...
                @if ($newPlan->price > 0)
                    ...
                    <form id="updateCard" style="display: none" action="{{ action('\horsefly\Cashier\Controllers\BraintreeController@updateCard', [
                        ...
                        <input type="hidden" name="redirect" value="{{ action('\horsefly\Cashier\Controllers\BraintreeController@changePlanPending', [
                            'subscription_id' => $subscription->uid,
                            'plan_id' => $newPlan->getBillableId(),
                        ]) }}" />
                    </form>
