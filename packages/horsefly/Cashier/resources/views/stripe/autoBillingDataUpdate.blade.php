<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ \horsefly\Cashier\Cashier::public_url('/vendor/acelle-cashier/css/main.css') }}">
    </head>
    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \horsefly\Cashier\Cashier::public_url('/vendor/acelle-cashier/image/stripe.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">
                ...
                <div class="sub-section">
                    @if ($cardInfo !== NULL)
                        ...
                        <form id="stripe_button"
                            action="{{ \horsefly\Cashier\Cashier::lr_action('\horsefly\Cashier\Controllers\StripeController@autoBillingDataUpdate') }}" method="POST">
                            {{ csrf_field() }}
                ...
                <form id="stripe_button" style="display:none"
                    action="{{ \horsefly\Cashier\Cashier::lr_action('\horsefly\Cashier\Controllers\StripeController@autoBillingDataUpdate', [
                    '_token' => csrf_token(),
                ]) }}" method="POST">
                ...
                <a
                    href="{{ \horsefly\Cashier\Cashier::lr_action('SubscriptionController@index') }}"
