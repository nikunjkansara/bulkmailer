...
@section('page_header')
    ...
    <div class="page-title">
        <ul class="breadcrumb breadcrumb-caret position-right">
            <li class="breadcrumb-item"><a href="{{ \horsefly\Cashier\Cashier::lr_action("HomeController@index") }}">{{ trans('messages.home') }}</a></li>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="d-flex align-items-center">
                <form method="POST"
                    action="{{ \horsefly\Cashier\Cashier::lr_action('\horsefly\Cashier\Controllers\OfflineController@claim', [
