        ...
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                @if (!$service->isClaimed($transaction))
                    ...
                    <hr>
                    <form method="POST" action="{{ action('\horsefly\Cashier\Controllers\DirectController@claim', ['subscription_id' => $subscription->uid]) }}">
                        {{ csrf_field() }}
                        <button
                ...
                <form class="mt-5" method="POST" action="{{ action('\horsefly\Cashier\Controllers\DirectController@cancelNow', ['subscription_id' => $subscription->uid]) }}">
                    {{ csrf_field() }}
