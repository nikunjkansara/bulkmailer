    ...
    <div class="row">
        <div class="col-md-6">
            @if (!$service->isClaimed($transaction))
                <h2>{!! trans('cashier::messages.direct.pending_renew.title') !!}</h2>  

                <p>{!! trans('cashier::messages.direct.pending_renew.intro', [
            ...
            @else
                <h2>{!! trans('cashier::messages.direct.pending_renew.claimed.title') !!}</h2>  
                <p class="mb-4">{!! trans('cashier::messages.direct.pending_renew.claimed.please_wait', [
                    'plan' => $subscription->plan->getBillableName(),
                    'price' => $subscription->plan->getBillableFormattedPrice(),
                ]) !!}</p>
