...
class LanguageController extends Controller
{
    ...
    {
        if (\Gate::denies('read', new \horsefly\Model\Language())) {
            return $this->notAuthorized();
        }

        $items = \horsefly\Model\Language::getAll();
    ...
    public function listing(Request $request)
    {
        ...
        $items = \horsefly\Model\Language::search($request)->paginate($request->per_page);
    ...
    {
        $language = new \horsefly\Model\Language([
    ...
    {
        $language = \horsefly\Model\Language::findByUid($id);
    ...
    {
        $items = \horsefly\Model\Language::whereIn('uid', explode(',', $request->uids));
    ...
    public function translate(Request $request, $id)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            try {
                ...
                $request->session()->put("parse_error", $e->getMessage());
    ...
    {
        $languages = \horsefly\Model\Language::whereIn('uid', explode(',', $request->uids));
