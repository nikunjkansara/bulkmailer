...
use horsefly\Model\BounceLog;
use horsefly\Model\SendingServer;
use horsefly\Model\SendingServerMailgun;
use horsefly\Model\SendingServerSendGrid;
use horsefly\Model\SendingServerElasticEmail;
use horsefly\Model\SendingServerSparkPost;
use horsefly\Model\FeedbackLog;
...
class DeliveryController extends Controller
{
        ...
        foreach($messages as $message) {
            switch ($message['event']) {
                ...
                case 'bounce':
                    ...
                    // retrieve the associated tracking log in Horsefly Mailer
    ...
    private function handleAws()
    {
        ...
        try {
            ...
            BackendErrorNotification::warning('Cannot handle AWS bounce/feedback. '.$e->getMessage(), false);
            return;
        }
