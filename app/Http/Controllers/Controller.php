...
class Controller extends BaseController
{
    ...
    {
        $user = \horsefly\Model\User::where('api_token', $api_token)->first();
    ...
    public function runMigration()
    {
        ...
        \horsefly\Model\Notification::truncate();
        sleep(5);
    ...
    {
        if(\horsefly\Model\Setting::get('remote_job_token') === $remote_job_token) {
