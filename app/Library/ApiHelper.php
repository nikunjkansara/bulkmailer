...
-d contact[country_id]=' .\horsefly\Model\Country::first()->id.' \
                    ...
                    'parameters' => [
                        ...
                        ['name' => '$options[...]', 'description' => 'Plan\'s options...<br>
                            <ul>
                                ...
                                <li><span class="text-semibold">sending_server_option</span>: ('.\horsefly\Model\Plan::SENDING_SERVER_OPTION_SYSTEM.'|'.\horsefly\Model\Plan::SENDING_SERVER_OPTION_OWN.'|'.\horsefly\Model\Plan::SENDING_SERVER_OPTION_SUBACCOUNT.')</li>
...
-d api_token=' .\Auth::user()->api_token.'  \
-d name=Advanced \
-d currency_id=' .\horsefly\Model\Currency::first()->id.' \
-d frequency_amount=1 \
-d frequency_unit=month \
-d price=20 \
-d color=red \
-d options[sending_server_option]=' .\horsefly\Model\Plan::SENDING_SERVER_OPTION_OWN.' \
