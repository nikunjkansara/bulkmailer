...
class Language extends Model
{
    ...
    {
        return $this->hasMany('horsefly\Model\User');
    }
    ...
    {
        return $this->hasMany('horsefly\Model\Admin');
    }
    ...
    public static function boot()
    {
        ...
        static::created(function ($item) {
            ...
            if (!file_exists($des)) {
                ...
                \horsefly\Library\Tool::xcopy($sou, $des);
                umask($oldmask);
            }
        });
        ...
        static::deleting(function ($item) {
            ...
            $item->customers()->update(['language_id' => $default_language->id]);
            $item->admins()->update(['language_id' => $default_language->id]);
        });
        ...
        static::deleted(function ($item) {
            ...
            $des = $item->languageDir();
            if (file_exists($des)) {
                \horsefly\Library\Tool::xdelete($des);
            }
        });
    }
    ...
    {
        return new \horsefly\Model\Language([
            'name' => 'Default',
            'code' => 'default',
        ]);
    }
    ...
    {
        return \horsefly\Model\Language::where('is_default', '=', true)->first();
    }
