...
class Setting extends Model
{
    ...
    public static function defaultSettings()
    {
        return [
            ...
            'default_language' => [
                ...
                'value' => 'en',
                'type' => 'select',
                'options' => \horsefly\Model\Language::getSelectOptions(),
            ],
            'frontend_scheme' => [
                'cat' => 'general',
                'value' => 'default',
            ...
            'geoip.engine' => [
                'cat' => 'others',
                'value' => 'mysql', # available values are sqlite|nekudo|mysql
                'type' => 'text',
                'not_required' => true,
            ],
            'geoip.enabled' => [
            ...
            'geoip.sqlite.source_url' => [
                'cat' => 'others',
                'value' => 'https://www.dropbox.com/s/l4n52l1hdvwlqsc/ip2locationdb11.db?dl=1',
                'type' => 'text',
                'not_required' => true,
            ],
    ...
    public static function updateLicense($license)
    {
        ...
        $license_type = \horsefly\Helpers\LicenseHelper::getLicenseType($license);
     ...
     * @var bool
     */
    public static function uploadFile($file, $type = null)
    {
