...
class Email extends Model
{
    ...
    {
        return $this->belongsTo('horsefly\Model\Automation2', 'automation2_id');
    }
    ...
    {
        return $this->hasMany('horsefly\Model\Attachment');
    }
    ...
    {
        return $this->hasMany('horsefly\Model\EmailLink');
    }
    ...
    public function transform()
    {
        ...
        $this->content = '<!DOCTYPE html>'.\horsefly\Library\Tool::replaceTemplateUrl($this->content, route('email_assets', ['uid' => $this->uid, 'path' => '']));
    ...
    {
        $this->content = null;
        \horsefly\Library\Tool::xdelete($this->getStoragePath());
        $this->save();
    }
