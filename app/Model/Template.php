...
class Template extends Model
{
    ...
    {
        $this->content = \horsefly\Library\Tool::replaceTemplateUrl($this->content, $template_path);
    }
    ...
    public function copy($name, $customer = null, $admin = null)
    {
        ...
        if (file_exists($this->getStoragePath())) {
            ...
            \horsefly\Library\Tool::xcopy($this->getStoragePath(), $copy->getStoragePath());
        }
    ...
    public function transform()
    {
        ...
        $this->content = '<!DOCTYPE html>'.\horsefly\Library\Tool::replaceTemplateUrl($this->content, route('template_assets', ['uid' => $this->uid, 'path' => '']));
    }
    ...
    public function load($path)
    {
        ...
        \horsefly\Library\Tool::xcopy($path, $this->getUploadDir());
    ...
    {
        \horsefly\Library\Tool::xcopy($template->getUploadDir(), $this->getUploadDir());
