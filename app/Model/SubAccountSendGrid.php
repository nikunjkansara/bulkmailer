...
class SubAccountSendGrid extends SubAccount
{
    ...
    {
        return $this->belongsTo('horsefly\Model\SendingServerSendGrid', 'sending_server_id');
    }
    ...
    public function updateApiKey()
    {
        try {
            // create an API key
            $response = $this->getApiClient()->createApiKey(['name' => 'Horsefly Mailer']);
    ...
    {
        $client = new \horsefly\Extra\SendGrid(['username' => $this->getSubAccountUsername(), 'password' => decrypt($this->password)]);
    ...
    public function getMasterApiClient()
    {
        ...
        $client = new \horsefly\Extra\SendGrid(['api' => $master->api_key]);
