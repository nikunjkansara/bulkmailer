...
class Payment extends Model
{
    ...
    {
        return $this->belongsTo('horsefly\Model\Subscription');
    }
    ...
    public function getErrorMessages()
    {
        ...
        if ($this->paymentMethod->type == \horsefly\Model\PaymentMethod::TYPE_BRAINTREE_PAYPAL ||
            $this->paymentMethod->type == \horsefly\Model\PaymentMethod::TYPE_BRAINTREE_CREDIT_CARD) {
        ...
        if ($this->paymentMethod->type == \horsefly\Model\PaymentMethod::TYPE_PAYPAL) {
