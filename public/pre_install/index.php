...
<body class="bg-slate-800">
	...
	<div class="text-right">                                    
		...
		<div class="footer text-white">
			&copy; 2016. <span class="text-white">Acelle Email Marketing Application</span> by <a href="http://horseflymailer.com" class="text-white" target="_blank">horseflymailer.com</a>			
		</div>
		<!-- /footer -->
